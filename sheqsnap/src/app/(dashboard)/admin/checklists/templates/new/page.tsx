...
import { Plus, X, ChevronUp, ChevronDown, ArrowLeft } from "lucide-react";
  ...
  return (
    <div className="space-y-6 max-w-3xl">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-2xl font-bold text-gray-900">New Checklist Template</h1>
          <p className="text-gray-500 mt-1">Define the template structure and items</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <Card>
          ...
          <CardContent className="space-y-3">
              ...
              <div key={index} className="border rounded-lg p-4 space-y-3 bg-gray-50">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <div>
                    ...
                    <Input
                      ...
                      placeholder="e.g. PPE worn correctly"
                    />
                  </div>
                  <div>
                ...
                <div>
                  ...
                  <Input
                    ...
                    className="mt-1 h-8 text-sm"
                    placeholder="Helper text for this item..."
                  />
                </div>
            ...
            {items.length === 0 && (
              <p className="text-center text-gray-400 py-4 text-sm">No items yet. Click &quot;Add Item&quot; to get started.</p>
            )}
          </CardContent>
        </Card>
